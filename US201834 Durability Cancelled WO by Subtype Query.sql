SELECT
    ...
    CASE
        WHEN COUNT(DISTINCT CASE WHEN wom."Work_Order_Status_Nm" = 'Closed'
                                 THEN wom."Work_Order_Nbr" END) > 0
        THEN CAST(
                 COUNT(DISTINCT CASE WHEN wom."Work_Order_Status_Nm" = 'Closed'
...
SELECT
    ...
    wom."Div_Nbr"     || '-' || dh."Cur_Div_Nm"   AS "Division",
    wom."Work_Order_Nbr",
    wom."Work_Order_Status_Nm",
    wom."Standard_Operation_Cd",
    wom."Standard_Operation_Nm",
    wom."Sub_Type",
    wom."Asset_Nbr",
    wom."Creation_Dt"
